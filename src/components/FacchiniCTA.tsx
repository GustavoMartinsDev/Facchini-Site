      ...
      <div className="section-container relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold text-white mb-8 leading-tight fadeIn">
            ...
            <span className="text-facchini-accent-1">no prazo e sem surpresas.</span>
          </h2>
          
          <p className="text-xl text-facchini-text-muted mb-12 fadeIn stagger-1">
            Transforme sua visão em realidade com a experiência de quem entrega resultados há 31 anos.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 pt-16 border-t border-facchini-divider fadeIn stagger-3">
            <div className="text-center">
              <div className="text-2xl font-bold text-facchini-accent-1 mb-2">31 anos</div>
              <div className="text-facchini-text-muted">de tradição e experiência</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-facchini-accent-1 mb-2">+170k m²</div>
              <div className="text-facchini-text-muted">entregues no prazo</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-facchini-accent-1 mb-2">100%</div>
              <div className="text-facchini-text-muted">transparência e controle</div>
            </div>
          </div>
        </div>
      </div>
